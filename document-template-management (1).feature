Feature: Quản lý danh sách mẫu chứng từ
  ...
  Background:
    ...
    And người dùng đang ở trang quản lý mẫu hóa đơn
  ...
  Scenario: Tạo mẫu chứng từ mới thành công
    When người dùng nhấn nút "Tạo mẫu hóa đơn"
    ...
    And mẫu mới có trạng thái "Đang sử dụng"
    And mẫu mới xuất hiện trong danh sách mẫu

  Scenario: Mẫu mới được đặt trạng thái sử dụng mặc định
    When người dùng tạo một mẫu chứng từ mới
    Then mẫu được tạo với trạng thái "Đang sử dụng" mặc định
  ...
  Scenario: Sao chép mẫu chứng từ hiện có
    ...
    And bản sao có trạng thái "Đang sử dụng" mặc định
  ...
  Scenario: Xem mẫu theo danh mục
    Given hệ thống có các danh mục mẫu như "Mẫu hóa đơn", "Mẫu cơ bản", "Chứng từ khấu trừ thuế TNCN"
    When người dùng chọn danh mục "Mẫu hóa đơn"
    Then chỉ các mẫu thuộc danh mục "Mẫu hóa đơn" được hiển thị
